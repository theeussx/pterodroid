...
> [!WARNING]A URL gerada por um Túnel Rápido **não é persistente** e muda a cada reinício do túnel. É recomendado apenas para testes ou uso esporádico.
...
> [!IMPORTANT]Neste modo, o roteamento de cada domínio (qual hostname vai para qual porta) **deve ser configurado diretamente no dashboard da Cloudflare**, na aba "Public Hostname" do túnel. Os campos de domínio nos formulários de serviço/banco do Pterodroid não se aplicam aqui.
